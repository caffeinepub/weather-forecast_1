...
export class Backend implements backendInterface {
    ...
    async getAllPreferences(): Promise<Array<Record_>> {
    ...
    async getPreferences(): Promise<Record_> {
        if (this.processError) {
            try {
    ...
    async savePreferences(arg0: string, arg1: number, arg2: number, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.savePreferences(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
